...
<div class="box-header with-border">
    ...
    <div class="row">
        <div class="col-xs-6">
            <a href="{{route('etudiant.releve.add')}}" id="aj"  class="btn btn-success glyphicon glyphicon-plus" > Ajouter</a>
        </div>
    </div>
</div>
                ...
                <tbody>
                    @foreach ($Listes as $Liste )
                        <tr>
                            ...
                            <td><a  href = "{{route('etudiant.releve.show',['table'=>$Liste])}} ">
                                <button type="edit">Voir les details</button></a></td>
                            <td><a  href = "{{route('etudiant.releve.annuler',['table'=>$Liste])}} ">
