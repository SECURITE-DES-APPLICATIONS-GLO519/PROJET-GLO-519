...
<div class="container">
    <aside>
        ...
        <nav>
            <ul>
                <li><a href="{{route('admin.dashboard-admin')}}">Accueil</a></li>
                <li><a href="{{route('admin.certificat.list')}}">Demande de certificat de scolarite</a></li>
                <li><a href="{{route('admin.releve.list')}}">Demande de releve de note</a></li>
                <li><a href="{{route('admin.diplome.list')}}">Demande de retrait du diplone</a></li>
            </ul>
        </nav>
        </section>
    </aside>
